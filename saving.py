...
save_path = "checkpoints/modelsave.ckpt"
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        print("Epoch: ",epoch," Training Loss: ",c," Training Accuracy: ", sess.run(accuracy, feed_dict={X: train_x, Y: train_y}))
    print("Testing Accuracy:", sess.run(accuracy, feed_dict={X: test_x, Y: test_y}))
    # Save the variables to disk
    save_path = saver.save(sess, "checkpoints/modelsave.ckpt")
...
with tf.Session() as sess:
    ...
    #saver.restore(sess, "checkpoints/modelsave.ckpt")
